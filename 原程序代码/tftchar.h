...
#ifndef __tftchar_h__
#define __tftchar_h__

#include<stdio.h>
#include"tftlcd.h"

										 
unsigned char code CHAR8X16[96][16] = //Font8x16
{//按照ASCII编码顺序
...
//回车换行
#define tftShowCRLF() tftSetCharXY(0,TFT_CHAR_Y+16)
...
//更  新:2012.3.6									
/********************************************************************************/
void tftShowStr(unsigned char *str)
{
	while(*str)
	{
		if(*str=='\n')
			...
			tftShowChar(8,16,CHAR8X16[*str-32]);
		str++;
	}
}
...
//函数名:tftShowHex
//功  能:显示十六进制字串
//参  数:str为要显示的字串 ,len为字串的字节数
//返回值:
//备  注:外部
//更  新:2012.3.6									
/********************************************************************************/
void tftShowHex(unsigned char *str,unsigned char len)
{
	unsigned char tmp;
	while(len--)
	{
		...
		if(tmp>9)
			...
			tmp=tmp+'0';
		tftShowChar(8,16,CHAR8X16[tmp-32]);
...
//更  新:2012.3.6									
/********************************************************************************/
void tftShowULong(unsigned long x)
{
